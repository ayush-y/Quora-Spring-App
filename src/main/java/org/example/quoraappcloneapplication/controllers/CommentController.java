...
import org.example.quoraappcloneapplication.Services.CommentService;
...
public class CommentController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Comment> getCommentById(@RequestBody Long id){

        Optional<Comment> comment = commentService.getCommentById(id);
        return comment.map(ResponseEntity::ok).orElseGet(() ->
